...
- **Flow state:** read `phase.md` only in the orchestrator — do not read full `.agents-state/current/*.md` here
...
- If the user asks to verify setup, suggest `specflow doctor` (optional `--run`)
